...
#import "MMVoiceAppDelegate.h"
#import "UIColor+MindMeldVoice.h"

#import <MindMeldSDK/MMListener.h>

@implementation MMVoiceAppDelegate

- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    [UINavigationBar appearance].barTintColor = [UIToolbar appearance].barTintColor = [UIColor mindMeldVoiceBlueColor];
